...
void printSubsequences(string str, string outputSoFar){

	if(str.length() == 0){
		cout << outputSoFar << endl;
		return;
	}
	// You decide not to include first char in final output
	printSubsequences(str.substr(1),outputSoFar);
	// You decide to include first char in final output
	printSubsequences(str.substr(1),  outputSoFar + str[0]);
}
...
void printKeypad(int num, string outputSoFar){
	...
	for(int i = 0; i < lastDigitOptions.length(); i++){
		printKeypad(num / 10, lastDigitOptions[i] + outputSoFar);
	}


	/*printKeypad(num / 10, lastDigitOptions[0] + outputSoFar);
	printKeypad(num / 10, lastDigitOptions[1] + outputSoFar);
	printKeypad(num / 10, lastDigitOptions[2] + outputSoFar);
	if(lastDigitOptions.length() == 4){
		// Append 4th char here
	}*/
}
